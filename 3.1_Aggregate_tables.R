...
table1Save <- table1 %>%
  ...
  group_by(RT, VE_COU, Year, Month, Csquare, LE_GEAR, met5, LE_MET, MSFD_BBHT, LENGTHCAT) %>%
...
table (table1Save$LE_GEAR %in%m4_ices$Key )   # TRUE records accepted in DATSU, FALSE aren't
